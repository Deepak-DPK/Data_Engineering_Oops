...
Slice out just the 200.50 
(ignoring the 1, for now to keep it simple, or handle it if you know how). 
Hint: Just slice from the correct index.
...
"""
Q3. f-String Logic Create a variable table = "users". 
Write an f-string that prints: "SELECT * FROM users WHERE active = 1;"
"""
